  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          <div className="mb-10">
            <span className="eluma-badge mb-3 inline-block">Community Funds</span>
        ...
        <ScrollReveal delay={3}>
          <section className="glass eluma-card rounded-2xl p-6 space-y-4">
            <span className="eluma-badge mb-2 inline-block">Verify</span>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="glass-surface eluma-card inline-flex cursor-pointer items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-light text-[var(--color-gsd-accent)] transition-theme hover:border-[var(--color-gsd-accent)]/50 hover:text-[var(--color-gsd-accent-hover)] hover:glow-cyan"
              >
                <svg
            ...
            <div className="glass-surface mt-4 rounded-xl border border-amber-500/20 bg-amber-500/5 px-4 py-3">
              <p className="text-sm font-light text-amber-300/90">
                <span className="font-normal text-[var(--color-gsd-gold)]">Burn tracking:</span> The
