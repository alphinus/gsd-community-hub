...
- In addition to processing gsd-hub program instructions, the indexer ALSO calls `detectRevenueInflow` (from `@/lib/revenue/detection`, created in plan 04-04) on EVERY transaction to detect raw SOL/USDC inflows to the treasury address.
