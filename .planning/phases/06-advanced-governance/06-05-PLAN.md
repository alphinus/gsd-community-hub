...
- When quadratic: Show "√(tokens) = vote weight" formula visually. E.g., "√(10,000) = 100 vote weight"
- When linear: Show "10,000 tokens = 10,000 vote weight"
- If delegatedAmount: Show breakdown "Your deposit: X + Delegated: Y = Total: Z → √(Z) = W weight"
